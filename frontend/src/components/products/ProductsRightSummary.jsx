          ...
          <div className="flex-1 min-w-0 space-y-1.5">
            {svgSlices.map((item, idx) => (
              ...
              >
                ...
                <span className="text-xs font-bold text-gray-900 font-mono shrink-0 ml-2">
      ...
      <div className="bg-white border border-gray-200/80 rounded-xl p-3 shadow-2xs space-y-2">
        <div className="flex items-center justify-between border-b border-gray-100 pb-2">
          ...
          <button
            ...
            className="text-xs font-medium text-[#047857] hover:text-[#00783C] flex items-center gap-0.5 cursor-pointer"
          >
            <span>View All</span>
          </button>
        </div>
              ...
              <div key={idx} className="flex items-center justify-between gap-1.5 text-xs">
                <div className="flex items-center gap-1.5 min-w-0">
                  ...
                  <div className="min-w-0">
                    <span className="font-semibold text-gray-900 text-xs block truncate max-w-[100px]">{item.name}</span>
                    <span className="text-[10px] text-gray-400 block truncate">Alert Below: {item.alertBelow}</span>
                  </div>
                </div>
                <span className={`text-xs font-bold font-mono shrink-0 ${item.color}`}>{item.qty}</span>
              </div>
            ))
          ) : (
            <div className="text-xs text-gray-400 text-center py-1">No low stock items</div>
          )}
        </div>
      </div>
      ...
      <div className="bg-white border border-gray-200/80 rounded-xl p-3 shadow-2xs space-y-2">
        ...
        <div className="grid grid-cols-2 gap-1.5 text-xs">
          ...
          >
            ...
            <span className="font-semibold text-xs leading-tight">Add Product</span>
          </button>
          ...
          >
            ...
            <span className="font-semibold text-xs leading-tight">Stock Entry</span>
          </button>
          ...
          >
            ...
            <span className="font-semibold text-xs leading-tight">Low Stock Report</span>
          </button>
          ...
          >
            ...
            <span className="font-semibold text-xs leading-tight">Product Categories</span>
          </button>
        </div>
      </div>
    </div>
